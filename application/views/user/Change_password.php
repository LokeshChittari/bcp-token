...
<head>
    ...
    <title>fulfill Coin | <?=$title?></title>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
                        ...
                        <div class="card card-signup">
                            <form class="form" method="post" action="<?=base_url('user/recover_password/').$update_id?>">
            ...
            <footer class="footer" style="margin-top: 140px;">
                <div class="container">
                    ...
                    <div class="copyright pull-right">
                        &copy; 2018, made with <i class="fa fa-heart heart"></i> by <a href="">Fulfill Coin</a>
                    </div>
                </div>
            </footer>
