                  ...
                  <div class="row">
                     <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
                        ...
                        <div class="card card-signup card-container">
                           ...
                           <form class="form" method="post" action="<?=base_url('user/login')?>">
                              <div class="text-center">
                                 <h4 style="color: #000;"><p><?=lang('LOGIN')?></p></h4>
                              ...
                              <div class="content">
                                 <div class="input-group">
                                    ...
                                    <input type="text" name="username"class="form-control" placeholder="<?=lang('EMAIL')?>" required/>
                              ...
                              <div class="footer text-center">
                                 <input type="submit" class="btn btn-info btn-icon" value="<?=lang('LOGIN')?>" name="submit"/>
                                 <p class="help-block" style="color: #960004 "><?=form_error('password_confirmation','<div class="help-block" style="color: red ">', '</div>')?></p>
                                 <!--<a href="<?=base_url('user/forgotpassword')?>" style="color: black;text-decoration: none;"><h5>forget password ?</h5></a>-->
                              </div>
                           </form>
                           <p class="text-center">Not Register yet <a href="<?=base_url('user/signup')?>">Sign Up</a></p>
                        </div>
                     </div>
                  </div>
               </div>
