<div class="page-title">
    <div class="title-env">
        <button class='btn btn-info btn-large' id='authorize_all' ><?=lang('AUTHORIZE_ALL')?></button>
        <button class='btn btn-info btn-large' id='unauthorize_all' ><?=lang('UNAUTHORIZE_ALL')?></button>   
    </div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?=lang('PERMISSION')?></h3>
